						...
						<?php if ($this->session->userdata('id_level') == 1) : ?>
							<li class="dropdown notifications-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<?php
									$this->db->select('pengajuan_cuti.*, id_level, nama_pegawai, ket_divisi');
											...
											<?php foreach ($notifikasi as $notif) : ?>
												<li>
													<a href="<?= base_url('approval'); ?>">
														<i class="fa fa-exclamation text-warning"></i> <?= $notif['nama_pegawai'] . ' ' . '(' . $notif['ket_divisi'] . ')'; ?>
													</a>
												</li>
											<?php endforeach; ?>
										</ul>
						...
						<?php else : ?>
							<li class="dropdown notifications-menu">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									$this->db->join('pengajuan_cuti', 'notif_staff.id_cuti = pengajuan_cuti.id_cuti');
									$this->db->where('notif_staff.id_user', $this->session->userdata('id_user'));
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									...
									<p>
										...
										<small><?= $this->fungsi->user_login()->ket_divisi ?></small>
									</p>
								</li>
